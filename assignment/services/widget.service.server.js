...
function findWidgetsByPageId(req, res) {
    var resultSet = [];
    for(var w in widgets) {
        if(widgets[w].widgetId === req.params.widgetId) {
...
function uploadImage(req, res) {
    ...
    var widget = {"_id":widgetId,"widgetType" :"IMAGE", "pageId" :pageId, "width" : width,
...
///Users/xuanyuli/Desktop/webdev/assignment1/li-xuanyu-webdev/assignment/public/uploads/75b19fa625c0eafd0d2173455a0fe15f
    console.log(widgets)
